...
print("="*80)
print("Evaluating Phase 3 WITHOUT DNA (TF-IDF + Domain-Adapted SBERT)")
print("="*80)
...
print("[+] Extracting standard TF-IDF features (1000 dims) to replace DNA...")
...
print("\n"+"="*80)
print("FINAL RESULTS WITHOUT DNA (30-Split Averages)")
print("="*80)
