# run_30_splits_phase2C.py
"""Phase 2-C: Ant Colony Optimization (ACO) feature selection + 11 classifiers."""
...
def main():
    ...
    print("\n[+] Phase 2-C: Running ACO Feature Selection...")
    t0 = time.time()
    ...
    print_results("Phase 2-C (ACO)", "Ant Colony Optimization", results,
                  "results/phase2C_aco_results.csv", elapsed)
