...
> **Reproducibility guarantee:** All results are generated by `run_final_reproducible.py` with `random_state=42` fixed everywhere — identical 10-Fold Stratified CV protocol for both phases. Running the script produces **bit-for-bit identical numbers** every time.

All results are evaluated on the **PROMISE NFR Dataset (969 requirements)** using a 434-dimensional DNA Hybrid Feature Vector (50-d TF-IDF + 384-d SBERT × 1.5).

Run to reproduce:
```bash
python run_final_reproducible.py
```

---

### Phase 1 vs Phase 2 — Full Comparison (10-Fold Stratified CV, random_state=42)

| Algorithm | Phase 1 Acc | Phase 2 Acc | Δ Acc | Phase 1 F1 | Phase 2 F1 | Δ F1 | Significant |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **SVM RBF** ⭐ | **84.41%** | 82.14% | -2.27% | 81.92% | 78.40% | -3.52% | YES |
| **SVM Linear** | 82.55% | 78.32% | -4.23% | 79.71% | 74.30% | -5.41% | YES |
| **Logistic Regression** | 81.73% | 77.19% | -4.54% | 79.03% | 72.37% | -6.66% | YES |
| **KNN (k=3)** | 77.39% | 78.53% | +1.13% | 69.75% | 70.88% | +1.13% | NO |
| **KNN (k=5)** | 76.57% | 78.22% | +1.65% | 68.97% | 70.35% | +1.38% | NO |
| **KNN (k=7)** | 75.12% | 78.63% | **+3.51%** | 65.56% | 70.19% | **+4.62%** | YES |
| **Gradient Boosting** | 75.23% | 75.44% | +0.21% | 63.61% | 64.97% | +1.37% | NO |
| **Random Forest** | 68.42% | 72.75% | **+4.34%** | 53.00% | 60.58% | **+7.58%** | YES |
| **AdaBoost** | 61.41% | 63.37% | +1.96% | 49.44% | 51.12% | +1.67% | NO |
| **Decision Tree** | 53.05% | 53.36% | +0.31% | 45.86% | 46.74% | +0.88% | NO |
| **Multinomial NB** | 49.64% | 71.10% | **+21.46%** | 18.78% | 58.20% | **+39.42%** | YES |
| **Naive Bayes** | 42.61% | 69.15% | **+26.54%** | 42.20% | 60.23% | **+18.03%** | YES |

> **Best Phase 1:** SVM RBF at **84.41%** — DNA Hybrid features are already near-optimal for kernel methods.
> **Best Phase 2 gain:** Naive Bayes **+26.54%** (p=9.37e-06, Cohen's d=2.97) — feature selection and scaling unlock massive improvement for probabilistic classifiers.

---

### Statistical Significance (Paired t-test + Wilcoxon, α=0.05)

| Algorithm | t-Statistic | p-value | Wilcoxon p | Cohen's d | Significant |
| :--- | :---: | :---: | :---: | :---: | :---: |
| SVM RBF | -2.2849 | 4.82e-02 | 5.86e-02 | -0.7616 | **YES** |
| SVM Linear | -4.5612 | 1.36e-03 | 3.91e-03 | -1.5204 | **YES** |
| Logistic Regression | -6.9207 | 6.91e-05 | 1.95e-03 | -2.3069 | **YES** |
| KNN (k=3) | 0.7964 | 4.46e-01 | 3.57e-01 | 0.2655 | NO |
| KNN (k=5) | 1.7797 | 1.09e-01 | 2.03e-01 | 0.5932 | NO |
| KNN (k=7) | 3.2222 | 1.05e-02 | 1.37e-02 | 1.0741 | **YES** |
| Gradient Boosting | 0.1874 | 8.56e-01 | 9.45e-01 | 0.0625 | NO |
| Random Forest | 7.5819 | 3.39e-05 | 1.95e-03 | **2.5273** | **YES** |
| AdaBoost | 1.9998 | 7.66e-02 | 1.33e-01 | 0.6666 | NO |
| Decision Tree | 0.1739 | 8.66e-01 | 8.46e-01 | 0.0580 | NO |
| Multinomial NB | 15.5523 | 8.24e-08 | 1.95e-03 | **5.1841** | **YES** |
| Naive Bayes | 8.8987 | 9.37e-06 | 1.95e-03 | **2.9662** | **YES** |
