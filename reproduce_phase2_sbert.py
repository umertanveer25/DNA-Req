...
print("="*80)
print("Phase 2 Reproducibility Script")
print("Model: TextToDNAEncoder + Pre-Trained SBERT ('all-MiniLM-L6-v2')")
...
print("[+] Adding Pre-Trained Deep Semantic SBERT (384 Dimensions)...")
sbert_frozen = SentenceTransformer('all-MiniLM-L6-v2')
X_sbert = sbert_frozen.encode(texts, show_progress_bar=True)

# Fuse vectors (giving equal or weighted importance)
